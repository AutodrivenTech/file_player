...
//        cout << "Re-load stereo image from image path" << endl;
        ...
        current_left_image = imread(current_stereo_left_name, IMREAD_ANYDEPTH);
        current_right_image = imread(current_stereo_right_name, IMREAD_ANYDEPTH);
      ...
      if(current_img_index < stereo_file_list_.size()-2){
          ...
          next_left_image = imread(next_stereo_left_name, IMREAD_ANYDEPTH);
          next_right_image = imread(next_stereo_right_name, IMREAD_ANYDEPTH);
...
//        cout << "Re-load omni image from image path" << endl;
        ...
        cv::Mat omni3_image;
        cv::Mat omni4_image;
        omni0_image = imread(current_omni0_name, IMREAD_COLOR);
        omni1_image = imread(current_omni1_name, IMREAD_COLOR);
        omni2_image = imread(current_omni2_name, IMREAD_COLOR);
        omni3_image = imread(current_omni3_name, IMREAD_COLOR);
        omni4_image = imread(current_omni4_name, IMREAD_COLOR);
...
//            omni4_info_pub_.publish(omni4_info_);
      ...
      if(current_img_index < omni_file_list_.size()-2){
          ...
          cv::Mat omni3_image;
          cv::Mat omni4_image;
          omni0_image = imread(next_omni0_name, IMREAD_COLOR);
          omni1_image = imread(next_omni1_name, IMREAD_COLOR);
          omni2_image = imread(next_omni2_name, IMREAD_COLOR);
          omni3_image = imread(next_omni3_name, IMREAD_COLOR);
          omni4_image = imread(next_omni4_name, IMREAD_COLOR);
          if(!omni0_image.empty() && !omni1_image.empty() && !omni2_image.empty() && !omni3_image.empty() && !omni4_image.empty()){
              cv::cvtColor(omni0_image, omni0_image, cv::COLOR_RGB2BGR);
              cv::cvtColor(omni1_image, omni1_image, cv::COLOR_RGB2BGR);
              cv::cvtColor(omni2_image, omni2_image, cv::COLOR_RGB2BGR);
